          ...
          >
            <blockquote className="max-w-md">
              <p className="text-2xl font-light leading-relaxed tracking-wide text-ivory-100/90 xl:text-3xl">
                «Память — это способ, которым мы продолжаем любить тех, кого больше нет рядом»
              </p>
          ...
          >
            <div className="mb-10 text-center lg:text-left">
              ...
              <p className="mt-3 text-sm font-light tracking-wide text-ivory-200/45">
                Войдите, чтобы создавать и беречь мемориалы
              </p>
            </div>
            ...
            >
              <div className="space-y-2">
                <label htmlFor="email" className="block text-sm font-light tracking-wide text-ivory-200/60">
                  Email
                </label>
                <input
                  id="email"
              ...
              <div className="space-y-2">
                <label htmlFor="password" className="block text-sm font-light tracking-wide text-ivory-200/60">
                  Пароль
                </label>
                <input
                  id="password"
            ...
            <p className="mt-8 text-center text-sm font-light tracking-wide text-ivory-200/40 lg:text-left">
              ...
              <Link
                href="/login"
                className="text-gold-500/80 transition-colors duration-300 hover:text-gold-400"
              >
                Зарегистрироваться
              </Link>
            </p>
